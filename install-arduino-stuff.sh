...
~/Applications/Arduino.app/arduino-cli --additional-urls "http://arduino.esp8266.com/stable/package_esp8266com_index.json" core update-index
~/Applications/Arduino.app/arduino-cli --additional-urls "http://arduino.esp8266.com/stable/package_esp8266com_index.json" core install esp8266:esp8266
